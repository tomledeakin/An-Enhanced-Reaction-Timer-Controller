...
namespace SimpleReactionMachine
{
            ...
            while (!quitePressed)
            {
                ...
                switch (key.Key)
                {
                    ...
                    case ConsoleKey.P: // Assigning the 'P' key to pause
                        ...
                        break;
                    case ConsoleKey.Y: // Assigning the 'P' key to pause
                        contoller.YesKeyPressed();
                        break;
                    case ConsoleKey.N: // Assigning the 'P' key to pause
                        contoller.NoKeyPressed();
                        break;
                }
            }
    ...
    public class EnhancedReactionController : IController
    {
        ...
        public void YesKeyPressed()
        {
            _state.YesKeyPressed();
        }
        ...
        abstract class State
        {
            ...
            public abstract void YesKeyPressed();
            public abstract void NoKeyPressed();
        }
        ...
        class OnState : State
        {
            ...
            public override void YesKeyPressed() { }
            public override void NoKeyPressed() { }
        }
        ...
        // Implement YesKeyPressed() and NoKeyPressed() similarly for other classes
        ...
        {
            public QuestionState(EnhancedReactionController con) : base(con)
            {
                controller.Gui.SetDisplay("one more turn?");
            }
        ...
        class GameOverState : State
        {
            ...
            private void CheckGames()
            {
                ...
                {
                    controller.SetState(new QuestionState(controller));
                    return;
                }
                controller.SetState(new WaitState(controller));
            }
